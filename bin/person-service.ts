...
const businessLogicStack = new PersonBusinessLogicStack(app, 'PersonBusinessLogicStack', {
  personTableName: dataStack.tableName, 
  personTableArn: dataStack.tableArn,
...
new PersonInterfaceStack(app, 'PersonInterfaceStack', {
  lambda: businessLogicStack.lambda},
  stackProps);
